...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_mimic_SOURCE_PREFIX /home/eloise/catkin-ws/src/yumi/gazebo_mimic)
  set(gazebo_mimic_DEVEL_PREFIX /home/eloise/catkin-ws/devel)
  ...
  set(gazebo_mimic_INSTALL_PREFIX /home/eloise/catkin-ws/install)
...
if(NOT "/home/eloise/catkin-ws/src/yumi/gazebo_mimic/include " STREQUAL " ")
  set(gazebo_mimic_INCLUDE_DIRS "")
  set(_include_dirs "/home/eloise/catkin-ws/src/yumi/gazebo_mimic/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_mimic' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Robert Krug <robert.krug@oru.se>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_mimic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eloise/catkin-ws/src/yumi/gazebo_mimic/${idir}'.  Ask the maintainer 'Robert Krug <robert.krug@oru.se>' to fix it.")
    endif()
