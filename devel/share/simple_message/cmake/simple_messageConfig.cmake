...
if("TRUE" STREQUAL "TRUE")
  set(simple_message_SOURCE_PREFIX /home/eloise/catkin-ws/src/industrial_core/simple_message)
  set(simple_message_DEVEL_PREFIX /home/eloise/catkin-ws/devel)
  ...
  set(simple_message_INSTALL_PREFIX /home/eloise/catkin-ws/install)
...
if(NOT "/home/eloise/catkin-ws/src/industrial_core/simple_message/include " STREQUAL " ")
  set(simple_message_INCLUDE_DIRS "")
  set(_include_dirs "/home/eloise/catkin-ws/src/industrial_core/simple_message/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_message' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eloise/catkin-ws/src/industrial_core/simple_message/${idir}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>' to fix it.")
    endif()
...
set(pkg_cfg_extras "/home/eloise/catkin-ws/src/industrial_core/simple_message/cmake/issue46_workaround.cmake")
