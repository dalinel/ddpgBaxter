...
def playGame(train_indicator=0):    #1 means Train, 0 means simply Run
    ...
    EXPLORE = 200.0*50
    episode_count = 10 if (train_indicator) else 1
    ...
    for i in range(episode_count):
        ...
        for j in range(max_steps):
            ...
            if np.random.random() > epsilon:
                ...
                a_type = "Explore"
                a_t = np.random.uniform(-1,1, size=(1,8))
        ...
        if np.mod(i, 3) == 0:
            if (train_indicator):
                ...
                actor.model.save_weights(path+"actormodel.h5", overwrite=True)
                critic.model.save_weights(path+"criticmodel.h5", overwrite=True)
        ...
        os.remove("/home/eloise/.gazebo/server-11345/gzserver.log")
        os.remove("/home/eloise/.gazebo/server-11345/default.log")
        os.remove("/home/eloise/.gazebo/client-11345/default.log")
        os.remove("/home/eloise/.gazebo/client-11345/gzclient.log")
        open('/home/eloise/.gazebo/server-11345/gzserver.log','a').close()
        open('/home/eloise/.gazebo/server-11345/default.log','a').close()
        open('/home/eloise/.gazebo/client-11345/default.log','a').close()
        open('/home/eloise/.gazebo/client-11345/gzclient.log','a').close()
