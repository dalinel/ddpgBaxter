...
echo_and_run cd "/home/eloise/catkin-ws/src/baxter_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/eloise/catkin-ws/src/baxter_tools/setup.py" \
    build --build-base "/home/eloise/catkin-ws/build/baxter_tools" \
    install \
    $DESTDIR_ARG \
