...
echo_and_run cd "/home/eloise/catkin-ws/src/baxter_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/eloise/catkin-ws/src/baxter_interface/setup.py" \
    build --build-base "/home/eloise/catkin-ws/build/baxter_interface" \
    install \
    $DESTDIR_ARG \
