...
if("FALSE" STREQUAL "TRUE")
  set(rethink_ee_description_SOURCE_PREFIX /home/eloise/catkin-ws/src/baxter_common/rethink_ee_description)
  set(rethink_ee_description_DEVEL_PREFIX /home/eloise/catkin-ws/devel)
  ...
  set(rethink_ee_description_INSTALL_PREFIX /home/eloise/catkin-ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rethink_ee_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eloise/catkin-ws/install/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
